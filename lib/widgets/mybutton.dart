            ...
            Container(
              ...
              Row(
                ...
                children: isLoading ?
                  ...
                  (icon == null) ?
                    [
                      Text(title, style: TextStyle(color: disableButton ?  Color.fromARGB(255, 255, 255, 255).withOpacity(0.3) : Colors.white, fontWeight: FontWeight.w600),)
                    ]
                    :
                    [
                      Icon(icon, size: 23, color: disableButton ? const Color.fromARGB(255, 230, 32, 32).withOpacity(0.3) : Colors.white,),
                      SizedBox(width: 5,),
